// Trainer Dashboard Redesign - Interactive Functionality
...
function updatePageHeader(sectionName) {
    ...
    const headers = {
        ...
        attendance: {
            ...
            subtitle: 'Mark session completion status for your classes',
            actions: ''
        },
        classes: {
            title: '<i class="bi bi-calendar-event-fill"></i> Class Schedules',
            subtitle: 'View your assigned class schedules',
            actions: ''
        },
        students: {
        ...
        leaves: {
            title: '<i class="bi bi-calendar-x-fill"></i> Leave Approval',
            subtitle: 'Review and approve student leave requests',
            actions: ''
        },
        food: {
            title: '<i class="bi bi-cup-hot-fill"></i> Food Selection',
            subtitle: 'Select your meals for the day',
            actions: ''
        }
    };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentUser) {
        ...
        if (userNameTop) {
            userNameTop.textContent = currentUser.name || 'Trainer';
        }
    }
});
