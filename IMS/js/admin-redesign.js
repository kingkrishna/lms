// Admin Dashboard Redesign - Interactive Functionality
...
function updatePageHeader(sectionName) {
    ...
    const headers = {
        ...
        trainers: {
            title: '<i class="bi bi-person-badge-fill"></i> Trainers',
            subtitle: 'Manage trainers and their activities',
            actions: `
        ...
        leaves: {
            ...
            subtitle: 'Review and approve leave applications',
            actions: `
        ...
        hostel: {
            ...
            subtitle: 'Manage hostel students and food preparation',
            actions: `
                <button class="btn btn-sm btn-primary" onclick="refreshAllData()">
                    <i class="bi bi-arrow-clockwise"></i> Refresh
                </button>
        ...
        canteen: {
            ...
            subtitle: 'Manage canteen stock and food selections',
            actions: `
                <button class="btn btn-sm btn-primary" onclick="refreshAllData()">
                    <i class="bi bi-arrow-clockwise"></i> Refresh
                </button>
        ...
        reports: {
            title: '<i class="bi bi-file-earmark-text-fill"></i> Reports',
            subtitle: 'Generate and view system reports',
            actions: ''
        },
        users: {
            title: '<i class="bi bi-person-gear-fill"></i> Users & Roles',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentUser) {
        ...
        if (userNameTop) {
            userNameTop.textContent = currentUser.name || 'Admin';
        }
    }
});
